...
from .models import TimetableEntry, ClaimForm
...
class ClaimFormAdmin(admin.ModelAdmin):
    list_display = ['staff_name','staff_email','month','submitted_at','comments','total','state'] 
    list_filter = ['staff_name','staff_email','month','submitted_at','comments','total','state']   
